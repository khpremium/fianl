...
<body>
	...
	<div class="card-body">
		<div class="input-group"> -->
			<form action="blogSearch.do" method="get" style="width:40%; width: 30%;float: right;">
				<input name="searchWord" type="text" class="form-control" placeholder="Search for..." style="float:left; width:75%;">
				<span class="input-group-btn">
					<button class="button special" type="submit" id="searchBtn" style="float:right; width:25%;">Go!</button>
				</span> 
			</form>
		<!-- </div>
	</div> -->
